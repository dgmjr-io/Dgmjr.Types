...
public abstract class UriDescriptionTuple : UriStringTuple
{
    ...
    protected UriDescriptionTuple(uri? uri, string? description = default)
    ...
    /// <param name="uri">The uri.</param>
    /// <param name="description">The description.</param>
    protected UriDescriptionTuple(string uri, string? description = default)
        : this(uri.ToUri(), description) { }
    ...
    operator string?(UriDescriptionTuple tuple) => tuple.Uri;
    public static implicit
    operator uri?(UriDescriptionTuple tuple) => tuple.Uri;

    public override bool Equals(object? obj)
    {
        return obj is UriDescriptionTuple tuple && base.Equals(obj) &&
               System.Collections.Generic.EqualityComparer<uri?>.Default.Equals(
                   Item1, tuple.Item1) &&
               Item2 == tuple.Item2 &&
               System.Collections.Generic.EqualityComparer<uri?>.Default.Equals(
                   Uri, tuple.Uri) &&

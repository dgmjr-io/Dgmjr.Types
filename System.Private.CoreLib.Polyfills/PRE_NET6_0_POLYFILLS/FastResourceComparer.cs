...
public sealed class FastResourceComparer
    : IComparer,
        IEqualityComparer,
        IComparer<string>,
        IEqualityComparer<string>
{
    public static readonly FastResourceComparer Default = new FastResourceComparer();
    ...
    public static unsafe int CompareOrdinal(byte* a, int byteLen, string b)
    {
        int num = 0;
        int num2 = 0;
        int num3 = byteLen >> 1;

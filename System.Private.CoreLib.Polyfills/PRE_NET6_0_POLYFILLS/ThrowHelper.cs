...
public static class ThrowHelper
{
    ...
    [DoesNotReturn]
    public static void ThrowArgumentException_ArgumentNull_TypedRefType()
    {
    ...
    [DoesNotReturn]
    public static void ThrowArgumentException_TupleIncorrectType(object obj)
    {
        throw new ArgumentException(
    ...
    [DoesNotReturn]
    public static void ThrowArgumentOutOfRange_Month(int month)
    {
        throw new ArgumentOutOfRangeException("month", month, SR.ArgumentOutOfRange_Month);
    }

    [DoesNotReturn]
    public static void ThrowArgumentOutOfRange_DayNumber(int dayNumber)
    {
        throw new ArgumentOutOfRangeException(
            "dayNumber",
            dayNumber,
    ...
    [DoesNotReturn]
    public static void ThrowArgumentOutOfRange_Range<T>(
    ...
    [DoesNotReturn]
    public static void ThrowOverflowException_TimeSpanTooLong()
    {
        throw new OverflowException(SR.Overflow_TimeSpanTooLong);
    }

    [DoesNotReturn]
    public static void ThrowArgumentException_Arg_CannotBeNaN()
    {
    ...
    [DoesNotReturn]
    public static void ThrowArgumentException_HandleNotSync(string paramName)
    {
        throw new ArgumentException(SR.Arg_HandleNotSync, paramName);
    }

    [DoesNotReturn]
    public static void ThrowArgumentException_HandleNotAsync(string paramName)
    {
    ...
    [DoesNotReturn]
    public static void ThrowNotSupportedException_UnseekableStream()
    {
        throw new NotSupportedException(SR.NotSupported_UnseekableStream);
    }

    [DoesNotReturn]
    public static void ThrowNotSupportedException_UnreadableStream()
    {
        throw new NotSupportedException(SR.NotSupported_UnreadableStream);
    }

    [DoesNotReturn]
    public static void ThrowNotSupportedException_UnwritableStream()
    {
        throw new NotSupportedException(SR.NotSupported_UnwritableStream);
    }

    [DoesNotReturn]
    public static void ThrowObjectDisposedException(object instance)
    {
    ...
    [DoesNotReturn]
    public static void ThrowObjectDisposedException_StreamClosed(string objectName)
    {
        throw new ObjectDisposedException(objectName, SR.ObjectDisposed_StreamClosed);
    }

    [DoesNotReturn]
    public static void ThrowObjectDisposedException_FileClosed()
    {
    ...
    [DoesNotReturn]
    public static void ThrowArgumentException_InvalidHandle(string paramName)
    {
        throw new ArgumentException(SR.Arg_InvalidHandle, paramName);
    }

    [DoesNotReturn]
    public static void ThrowUnexpectedStateForKnownCallback(object state)
    {
        throw new ArgumentOutOfRangeException(
            "state",
            state,
    ...
    [DoesNotReturn]
    public static void ThrowArraySegmentCtorValidationFailedExceptions(
        Array array,
        int offset,
        int count
    )
    ...
    [DoesNotReturn]
    public static void ThrowFormatException_NeedSingleChar()
    {
        throw new FormatException(SR.Format_NeedSingleChar);
    }

    [DoesNotReturn]
    public static void ThrowFormatException_BadBoolean(ReadOnlySpan<char> value)
    {
    ...
    [DoesNotReturn]
    public static void ArgumentOutOfRangeException_Enum_Value()
    {

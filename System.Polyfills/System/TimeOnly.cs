...
namespace System
{
...
#endif
    {
        ...
        public TimeOnly(int hour, int minute)
            : this(TimeToTicks(hour, minute, 0, 0)) { }
        ...
        public TimeOnly(int hour, int minute, int second)
            : this(TimeToTicks(hour, minute, second, 0)) { }
        ...
        public TimeOnly(int hour, int minute, int second, int millisecond, int microsecond)
            : this(TimeToTicks(hour, minute, second, millisecond, microsecond)) { }
        ...
        private static void ThrowMillisecondOutOfRange() =>
            throw new ArgumentOutOfRangeException(
                "millisecond",
                $"Valid values are between 0 and {MillisPerSecond - 1}, inclusive."
            );

        private static void ThrowMicrosecondOutOfRange() =>
            throw new ArgumentOutOfRangeException(
                "microsecond",
                $"Valid values are between 0 and {MicrosecondsPerMillisecond - 1}, inclusive."
            );
